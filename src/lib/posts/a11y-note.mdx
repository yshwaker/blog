...
<img src="/blog-images/a11y-text.png" width={402} height={85} alt="中英文字体上下空白区域对比" style="margin: 0 auto; display: block;"/>


#### 响应式设计中断点的单位

通常我们在`@media`规则中使用如`500px`，`1100px`，`1500px`等断点来区分手机、平台、PC等不同使用场景。但是当我们预期用户会修改浏览器的默认字体大小时，这样的断点设置方式是否合理呢？
<img src="/blog-images/default-font-size-setting.png" width={1592  / 2} height={304 / 2} alt="默认字体大小设置" style="margin: 0 auto; display: block;"/>
...
```
<img src="/blog-images/a11y-clickable-area.png" width={414 / 2} height={434 / 2} alt="可点击预期演示" style="margin: 0 auto; display: block;"/>
...
<img src="/blog-images/a11y-contrast.png" width={670 / 2} height={484 / 2} alt="对比度调试" style="margin: 0 auto; display: block;"/>
...
<img src="/blog-images/vision-deficiencies-emulation.png" width={968 / 2} height={684 / 2} alt="模拟色盲" style="margin: 0 auto; display: block;"/>
